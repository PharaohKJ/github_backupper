...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Backup yout GitHub repositories, issues, wikis to local file.}
  spec.description   = %q{Backup yout GitHub repositories, issues, wikis to local file.}
